...
const useStyles = makeStyles((theme) => ({
    ...
    circlePrefixDiv : {
        border : '2px solid ' + theme.palette.green.G200 , borderRadius : theme.border.borderRadius.half,
        width : 10, height : 10,
    }
})) ;
                            ...
                            return (
                                ...
                                >
                                    <Box className={classes.solItemLabel}>
                                        <Box className={classes.circlePrefixDiv} sx={{backgroundColor : (solIndex === index && productSelected) ? theme.palette.green.G200 : 'transparent'}}></Box>{sol.name}
                                    </Box>
