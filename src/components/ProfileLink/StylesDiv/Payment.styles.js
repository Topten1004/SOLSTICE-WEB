...
export const useStyles = makeStyles((theme) => ({
    ...
    rootExpand : {
        ...
        animation: `$root-expand-animation 300ms ease-in-out running` ,
        ...
        ['@media (max-width : 575px)'] : {
            ...
            borderLeft : 'none',
            animation :`$root-expand-mobile-575-animation 300ms ease-in-out running` ,
        },
        ['@media (max-width : 520px)'] : {
            top : 'calc(100vh - 600px)',
            height : 600,
            animation :`$root-expand-mobile-520-animation 300ms ease-in-out running` ,
        },
    ...
    rootLess : {
        ...
        zIndex : 2000,
        background : '#283940',
        animation: `$root-less-animation 300ms ease-in-out running` ,
        ['@media (max-width : 575px)'] : {
            width : '100%',
            top : '100vh',
            right : 0,
            ...
            borderBottom : 'none',
            borderBottomLeftRadius : 0,
            animation :`$root-less-mobile-575-animation 300ms ease-in-out running` ,
        },
        ['@media (max-width : 520px)'] : {
            height : 600,
            animation :`$root-less-mobile-520-animation 300ms ease-in-out running` ,
        },
        backdropFilter : 'blur(4px)'
    },
    mainDiv : {
    ...
    walletDiv : {
        ...
        width : 220,
        padding : 10,
        color : theme.palette.green.G200, fontSize : 15,
