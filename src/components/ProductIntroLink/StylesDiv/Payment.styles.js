...
export const useStyles = makeStyles((theme) => ({
    ...
    rootExpand : {
        ...
        ['@media (max-width : 370px)'] : {
            ...
            borderLeft : 'none',
            animation :`$root-expand-mobile-370-animation 300ms ease-in-out running` ,
        },
    ...
    rootLess : {
        ...
        ['@media (max-width : 370px)'] : {
            ...
            borderBottom : 'none',
            borderBottomLeftRadius : 0,
            animation :`$root-less-mobile-370-animation 300ms ease-in-out running` ,
        },
        backdropFilter : 'blur(4px)'
    },
    mainDiv : {
    ...
    "@keyframes root-less-mobile-370-animation" : {
        "0%" : {
            top : 'calc(100vh - 360px)',
        },
        "100%" : {
    ...
    "@keyframes root-expand-mobile-370-animation" : {
        "0%" : {
            top : '100vh'
        },
        "100%" : {
