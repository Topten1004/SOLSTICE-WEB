...
export const useStyles = makeStyles((theme) => ({
    ...
    itemDiv : {
        cursor : 'pointer',
        border  : '3px solid ' + theme.palette.green.G200,
    ...
    messageDiv : {
        ...
        marginBottom : 30,
        zIndex : 1,
        color : theme.palette.green.G200, fontSize : '20px !important', fontFamily : 'Montserrat !important',
        background: 'rgba(51, 139, 239, 0.21) !important',
    ...
    hoveringDiv : {
        "&:hover" : {
            boxShadow : '0px 12px 20px ' + theme.palette.blue.B300,
            marginTop : -10,
        },
        borderRadius : 20,
        transition: 'all .2s ease'
